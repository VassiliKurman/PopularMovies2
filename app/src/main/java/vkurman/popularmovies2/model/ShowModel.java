...
/**
 * ShowModel is needed for {@link TMDBService @TMDBService} network request.
...
public class ShowModel {
    ...
    @Expose
    private List<Crew> createdBy = null;
    ...
    public List<Crew> getCreatedBy() {
        return createdBy;
    }

    public void setCreatedBy(List<Crew> createdBy) {
